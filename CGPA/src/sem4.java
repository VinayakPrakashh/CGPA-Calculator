...
int value;
 ...
 sem1t.setVisible(false);
  ...
  try{
    ...
    private void initComponents() {
        ...
        jPanel1.add(sem1t3);
        sem1t3.setBounds(730, 170, 100, 40);

        jLabel26.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setText("SEM 3 TOTAL :");
        jPanel1.add(jLabel26);
        jLabel26.setBounds(550, 170, 160, 40);
        ...
        jPanel1.add(sem1t2l);
        sem1t2l.setBounds(840, 120, 160, 40);
        ...
        jPanel1.add(sem1tl);
        sem1tl.setBounds(550, 120, 170, 40);
        ...
        jPanel1.add(sem1t);
        sem1t.setBounds(730, 120, 100, 40);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(510, 200, 260, 80);
  ...
  cgpa2 = (totalmark2 / 60);
   ...
   try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblclet SET totalmark=('"+sem1tot+"') WHERE id = 2";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
    ...
    try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblclet SET sum3 = (SELECT SUM(totalmark) as sum_i FROM tblclet WHERE id < 3) where id =1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
  ...
  cgpa2 = (totalmark2 / 115);
   ...
   try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblc SET totalmark=('"+sem1tot+"') WHERE id = 4";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
 ...
 try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblc SET sum1 = (SELECT SUM(totalmark) as sum_i FROM tblc WHERE id < 5) where id =1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
