...
public class sem1 extends javax.swing.JFrame {
 String tmark;
    ...
    private void initComponents() {
        ...
        em1S.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                em1SFocusLost(evt);
            }
        });
        em1S.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                em1SActionPerformed(evt);
            }
        });
        jPanel1.add(em1S);
        ...
        ec1S.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                ec1SFocusLost(evt);
            }
        });
        ec1S.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                ec1SInputMethodTextChanged(evt);
            }
        });
        ec1S.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ec1SActionPerformed(evt);
            }
        });
        jPanel1.add(ec1S);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(510, 180, 260, 30);
        ...
        System.out.println(sem1tot);
         try{
                ...
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                 ...
                 String sql="UPDATE tblc SET totalmark=('"+sem1tot+"') WHERE id = 1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
 ...
 try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblc SET sum1 = (SELECT SUM(totalmark) as sum_i FROM tblc WHERE id=1) where id =1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
    ...
    }//GEN-LAST:event_ec1SActionPerformed
    ...
    private void em1SActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_em1SActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_em1SActionPerformed

    private void ec1SFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_ec1SFocusLost
        // TODO add your handling code here:
                                             String i;
        i=ec1S.getText();
    ...
    }//GEN-LAST:event_ec1SFocusLost

    private void em1SFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_em1SFocusLost
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_em1SFocusLost

    private void ec1SInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_ec1SInputMethodTextChanged
        // TODO add your handling code here:
                                             
      
    }//GEN-LAST:event_ec1SInputMethodTextChanged
