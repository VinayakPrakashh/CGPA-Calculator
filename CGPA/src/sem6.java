...
sem1t1.setVisible(false);
  ...
  try{
   ...
   try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
            String sql="SELECT totalmark FROM tblclet WHERE id = 3";
...
try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
            String sql="SELECT totalmark FROM tblc WHERE id = 5";
    ...
    private void initComponents() {
        ...
        jPanel1.add(sem1tl);
        sem1tl.setBounds(200, 420, 160, 40);
        ...
        jLabel25.setText("SEM 3 TOTAL :");
        jPanel1.add(jLabel25);
        jLabel25.setBounds(830, 120, 160, 40);
        ...
        jPanel1.add(sem1t2);
        sem1t2.setBounds(720, 120, 100, 40);
        ...
        jPanel1.add(sem1t2l);
        sem1t2l.setBounds(550, 120, 160, 40);
        ...
        jPanel1.add(jLabel7);
        jLabel7.setBounds(507, 230, 260, 30);
  ...
  cgpa2 = (totalmark2 / 120);
   ...
   try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblclet SET totalmark=('"+sem1tot+"') WHERE id = 4";
                System.out.println(sql);
                Statement stmt=con.createStatement();
    ...
    try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblclet SET sum3 = (SELECT SUM(totalmark) as sum_i FROM tblclet WHERE id < 7) where id =1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
  ...
  double rounded = Math.round(cgpa2*100)/100.0;
   ...
   try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblc SET totalmark=('"+sem1tot+"') WHERE id = 6";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
   ...
   try{
                Class.forName("com.mysql.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_cgpa","root","");
                String sql="UPDATE tblc SET sum1 = (SELECT SUM(totalmark) as sum_i FROM tblc WHERE id < 7) where id =1";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
