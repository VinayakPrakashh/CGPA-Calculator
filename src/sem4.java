    ...
    double rgpa = Math.round(cgpa2*100)/100.0;
        ...
        System.out.println(sem1tot);
         try{
                ...
                String sql="UPDATE tbl_main SET tot_cgpal=('"+cgpA+"'),em4_pl=('"+sem1tot+"'),tot_pl = sem3_pl+sem4_pl WHERE username='"+Login.username+"'";
                System.out.println(sql);
                Statement stmt=con.createStatement();
   ...
   double rgpa = Math.round(cgpa*100)/100.0;
        ...
        System.out.println(sem1tot);
          try{
                ...
                String sql="UPDATE tbl_main SET tot_cgpa=('"+cgpA+"'),sem4_p=('"+sem1tot+"'),tot_p = sem1_p+sem2_p+sem3_p+sem4_p WHERE username='"+Login.username+"'";
                System.out.println(sql);
                Statement stmt=con.createStatement();
                int rs = stmt.executeUpdate(sql);
