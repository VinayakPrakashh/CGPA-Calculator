...
public class sem2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(sem1t);
        sem1t.setBounds(780, 150, 100, 40);

        jLabel22.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(255, 255, 255));
        jLabel22.setText("SEM1 GRADE POINTS :");
        jPanel1.add(jLabel22);
        jLabel22.setBounds(590, 150, 190, 40);
        ...
        jTextField5.setBounds(380, 520, 40, 30);
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (ec2S.getText().isEmpty() || em2S.getText().isEmpty() || ep2S.getText().isEmpty() || ech2S.getText().isEmpty() || pcS.getText().isEmpty() || egS.getText().isEmpty() || wpS.getText().isEmpty() || esl2S.getText().isEmpty() || pclSE.getText().isEmpty() || lsS.getText().isEmpty()) {
            ...
            try {
                Connection con = Database.connect();
                String sql = "UPDATE tbl_main SET tot_cgpa=('" + cgpA + "'),sem2_p=('" + sem1tot + "'),tot_p =sem1_p+sem2_p WHERE username='" + Login.username + "'";
                System.out.println(sql);
                Statement stmt = con.createStatement();
